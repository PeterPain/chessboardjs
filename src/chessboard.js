...
;(function() {
	...
	CSS['heattile'] = 'heattile-45c36'
	CSS['heatvalue'] = 'heatvalue-22bf39'
		...
		function buildBoardHTML(orientation) {
			...
			for (var i = 0; i < 8; i++) {
				...
				for (var j = 0; j < 8; j++) {
					...
					// add heat map value container
					html += '<div class="' + CSS.heatvalue + '"></div>'

					html += '</div>' // end heattile
